...
entry_widget = tk.Entry(root, width = 20) # Initiate the Entry widget here
...
# Create a Label
label = tk.Label(master = root, text = "")# Initiate the Label widget here
...
radio_button1.grid(row=3, column=0, padx=10, pady=10)
radio_button2 = tk.Radiobutton(master=root, text="Option 2", variable=radio_value, value=2)
radio_button2.grid(row=3, column=1, padx=10, pady=10)
